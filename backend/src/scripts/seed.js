...
const productsData = [
  ...
  { title: "Organic Assam Orthodox Whole Leaf Black Tea", description: "Artisanal Golden Flowery Orange Pekoe (GFOP) whole leaf tea harvested from certified organic tea gardens in Dibrugarh.", price: 890, categorySlug: "spices" },
  { title: "Karbi Anglong Organic Lakadong Turmeric Powder", description: "100% pure organic Lakadong turmeric with 7.8%+ curcumin content and intense aromatic flavor.", price: 380, categorySlug: "spices" },
  { title: "Artisanal Bhut Jolokia (Ghost Pepper) Pickle", description: "Authentic homemade spicy pickle made from world-famous GI-tagged Bhut Jolokia cured in mustard oil.", price: 299, categorySlug: "spices" },
  { title: "Kazi Nemu & Wild Cardamom Spiced Assam Chai", description: "Robust strong CTC tea leaf blend infused with sun-dried Assam Kazi Nemu lemon zest, wild Karbi cardamom, and black pepper.", price: 540, categorySlug: "spices" },
